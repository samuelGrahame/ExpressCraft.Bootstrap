...
namespace ExpressCraft.Bootstrap
{
	public class BootWindow : Form
	{
		...
		private StyleStates PreviouStates;
		...
		private enum StyleStates
		{
			None = 0,
			Width480Landscape = 1,
			WidthLess767 = 2,
			WidthGreater768Less991 = 4,
			WidthGreater768 = 8,
			WidthGreater992 = 16,
			WidthGreater1200 = 32
		}
		...
		{			
			StyleStates states = StyleStates.None;			
